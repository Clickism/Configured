...
package de.clickism.configured.neoforgecommandadapter;
...
public class NeoforgeCommandAdapter {
     ...
     */
    protected NeoforgeCommandAdapter(Config config) {
        this.config = config;
    }
     ...
     */
    public static NeoforgeCommandAdapter ofConfig(Config config) {
        return new NeoforgeCommandAdapter(config);
    }
     ...
     */
    public NeoforgeCommandAdapter requires(Predicate<CommandSourceStack> requirement) {
     ...
     * @return the current PaperCommandAdapter instance
     */
    public NeoforgeCommandAdapter add(AbstractSubCommand subCommand) {
