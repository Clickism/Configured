...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "configured-paper-command-adapter"
            version = version.toString()
            pom {
                name.set("Configured - Paper Command Adapter")
                description.set("PaperMC command adapter for the Configured configuration library.")
