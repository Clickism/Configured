...
package de.clickism.configured.papercommandadapter;

import com.mojang.brigadier.builder.LiteralArgumentBuilder;
import de.clickism.configured.Config;
import de.clickism.configured.papercommandadapter.command.AbstractSubCommand;
...
public class PaperCommandAdapter {
     ...
     */
    protected PaperCommandAdapter(Config config) {
        this.config = config;
    }
     ...
     */
    public static PaperCommandAdapter ofConfig(Config config) {
        return new PaperCommandAdapter(config);
    }
     ...
     */
    public PaperCommandAdapter requires(Predicate<CommandSourceStack> requirement) {
     ...
     * @return the current PaperCommandAdapter instance
     */
    public PaperCommandAdapter add(AbstractSubCommand subCommand) {
